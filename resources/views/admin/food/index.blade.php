            ...
            <div class="card-body p-0">
                <table class="table table-striped projects">
                    ...
                    <tbody>
                        ...
                        <td>
                            <a href="{{route('foods.show', $product->product_id)}}" class="btn = btn-sm" style="background-color: #4DD54F; color: white;">
                                Просмотр
                            </a>
                        </td>
                        <td>
                        ...
                        <td>
                        <a href="{{route('foods.edit', ['food' => $product->product_id])}}" class="btn btn-info btn-sm">
            ...
            <div class="card-body p-0">
                <table class="table table-striped projects">
                    ...
                    <tbody>
                        ...
                        <td>{{$product->created_at}}</td>
                        <td>
                            <a href="{{route('foods.show', ['food' => $product->product_id])}}" class="btn = btn-sm" style="background-color: #4DD54F; color: white;">
                                Просмотр
                            </a>
                        </td>
                        <td>
