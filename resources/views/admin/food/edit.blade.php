...
@section('title', 'Обновить Питание')
...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Обновить Питание</h1>
          </div><!-- /.col -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-primary">
                    <form action="{{route('foods.update', $product->id)}}" method="post" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <br>
                                <select class="form-control" id="exampleInputCategory" name="category" id="asd">
                                ...
                                <br>
                                <input type="number" name="weight" class="form-control" id="exampleInputCategory" value='{{$product->weight}}'>
                                <br>
