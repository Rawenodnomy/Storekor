                    ...
                    <form action="{{route('news.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="exampleInputCategory" placeholder="Введите заголовок новости" ><br>

                                <label for="file-upload" class="file-input">
                                Добавить фото новости
                                ...
                                <label for="exampleInputCategory">Содержание новости</label>
