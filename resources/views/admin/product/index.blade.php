            ...
            <div class="card-body p-0">
                <table class="table table-striped projects">
                    ...
                    <tbody>
                        ...
                        @if ($product->count < 10)
                        <tr><td>{{$product->id}}</td>
                        <td>{{$product->name}} @if ($product->group_name!=null) ({{$product->group_name}}) @endif</td>
                        <td>{{$product->type}}</td>
                        <td>{{$product->count}}</td>
                        <td>{{$product->price}}</td>
                        <!-- <td>{{$product->count}}</td> -->
                        ...
                        <td>
                            <a href="{{route('comments.index', ['id' => $product->id])}}" class="btn = btn-sm" style="background-color: blue; color: white;">
                                Комментарии 
                            </a>
                        </td>
                        <td>
                        <a href="{{route('products.edit', ['product' => $product->id])}}" class="btn btn-info btn-sm">
