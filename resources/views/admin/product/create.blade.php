                    ...
                    <form action="{{route('products.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="exampleInputCategory" placeholder="Введите название товара" ><br>
                                <label for="exampleInputCategory">Цена</label><br>
                                ...
                                <br>
                                <select onchange="handleSelectChange(event)" class="form-control" id="exampleInputCategory" name="type_id" id="asd">
                                ...
                                <br>
                                <div id='count_product' style='display:none;'>
