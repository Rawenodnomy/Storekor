...
@section('title', 'Добавить Инфоблок')
...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Добавить Инфоблок</h1>
          </div><!-- /.col -->
                    ...
                    <form action="{{route('infos.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="exampleInputCategory" placeholder="Введите название инфоблока">
                                <br>
                                <!-- <label for="exampleInputCategory">Фото инфоблока</label> -->
                                <!-- <input type="file" name="img" class="form-control" id="exampleInputCategory"> -->
